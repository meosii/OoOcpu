`ifndef OOOCPU_DEFINE
`define OOOCPU_DEFINE
...
`define BR_OP_NOP    4'd0
`define BR_OP_JAL    4'd1
`define BR_OP_JALR   4'd2
`define BR_OP_BEQ    4'd3
`define BR_OP_BNE    4'd4
`define BR_OP_BLT    4'd5
`define BR_OP_BLTU   4'd6
`define BR_OP_BGE    4'd7
`define BR_OP_BGEU   4'd8
